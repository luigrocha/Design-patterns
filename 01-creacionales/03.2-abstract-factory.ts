...
class ElectricCar implements Vehicle {
  ...
  assemble(): void {
    console.log('====================================');
    console.log('%cAssembling Electric Car', COLORS.yellow);
  }
}
...
class GasCar implements Vehicle {
  ...
  assemble(): void {
    console.log('====================================');
    console.log('%cAssembling Gas Car', COLORS.red);
  }
}
...
class ElectricEngine implements Engine {
  ...
  start(): void {
    console.log('====================================');
    console.log('%cStarting Electric Engine', COLORS.pink);
  }
}
...
class GasEngine implements Engine {
  ...
  start(): void {
    console.log('====================================');
    console.log('%cStarting Gas Engine', COLORS.brown);
  }
}
